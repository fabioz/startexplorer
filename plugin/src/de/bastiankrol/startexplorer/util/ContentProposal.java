...
/**
 * Backported from org.eclipse.jface, version 3.7.
 * 
...
public class ContentProposal implements IContentProposal
{
   ...
   * The cursor position will be located at the end of the content.
   * 
   * @param content the String representing the content. Should not be
   *          <code>null</code>.
   */
  ...
  /**
   * Create a content proposal whose content and description are as specified in
   * the parameters. The cursor position will be located at the end of the
   * content.
   * 
   * @param content the String representing the content. Should not be
   *          <code>null</code>. This string will also be used as the label.
   * @param description the String representing the description, or
   ...
   * specified in the parameters. The cursor position will be located at the end
   * of the content.
   * 
   * @param content the String representing the content. Should not be
   *          <code>null</code>.
   * @param label the String representing the label. Should not be
   *          <code>null</code>.
   * 
   * @param description the String representing the description, or
   *          <code>null</code> if there should be no description.
   ...
   *          <code>null</code> if there should be no description.
   * 
   * @param cursorPosition the zero-based index position within the contents
   *          where the cursor should be placed after the proposal is accepted.
   *          The range of the cursor position is from 0..N where N is the
   *          number of characters in the content.
   * 
   * @exception IllegalArgumentException if the index is not between 0 and the
   *              number of characters in the content.
   */
  public ContentProposal(String content, String label, String description,
      int cursorPosition)
