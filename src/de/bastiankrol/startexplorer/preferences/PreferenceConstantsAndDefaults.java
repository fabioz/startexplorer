...
public class PreferenceConstantsAndDefaults
{
  ...
  // static final String PREFERENCES_NODE_QUALIFIER =
  // "de.bastiankrol.startexplorer.preferencesScope";
  ...
  public static final CommandConfig[] DEFAULT_CUSTOM_COMMANDS = new CommandConfig[] {
      ...
      new CommandConfig("edit ${resource_path}", true, "Dos-Edit", false, null) ,
      new CommandConfig("1", true, "1", true, "1"),
      new CommandConfig("2", true, "2", true, "2"),
      new CommandConfig("3", true, "3", true, "3"),
      new CommandConfig("4", true, "4", true, "4")
  };
